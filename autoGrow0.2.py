...
def main():
  ...
  while True:
    ...
    print(u'|\u25BC '+colored(str(mainBox.sensArrayXXX[1].temperatureC),color=mainBox.getColor(mainBox.sensArrayXXX[1].temperatureC, 30, 40)) + u'C\u00ba\u25B2 \u25BC|  \u2551 \u255a\u2550\u2551\u25baIN  \u2588\u2588   '+colored(str(mainBox.sensArrayXXX[2].temperatureC),color=mainBox.getColor(mainBox.sensArrayXXX[4].temperatureC, 30, 40)) +'C\u00ba\u25B2  \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2551         |\u25B2           \u25B2|')
    print(u'|\u2588          \u2588|  \u2551   \u2551220V \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588 OUT\u25ba\u2551\u2550\u2550\u2550\u2550\u2550\u2550\u2557  |\u2588           \u2588|')
