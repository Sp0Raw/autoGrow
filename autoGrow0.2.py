...
def main():
  ...
  while True:
    ...
    print("%%%%%%%%  LAMP HEALTH  %%%%%%%%%%%%")
    print(u'|\u2588\u2588\u25BC\u25BC  IN  \u25BC\u25BC\u2588|                                           |\u2588\u2588\u25B2   OUT  \u25B2\u2588\u2588|')
    print(u'|\u2588\u2588  '+colored(mainBox.sensArrayXXX[3].temperatureC,color=mainBox.getColor(mainBox.sensArrayXXX[3].temperatureC, 30, 40)) + u' C \u2588|                                           |\u2588\u2588\u2588 '+colored(mainBox.sensArrayXXX[4].temperatureC,color=mainBox.getColor(mainBox.sensArrayXXX[4].temperatureC, 35, 40)) + u' C \u2588\u2588|')
